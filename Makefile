...
GOFILES = api/account.go api/activity.go api/clarification.go api/contest.go api/execution.go api/notification.go api/problem.go api/session.go api/language.go api/standing.go api/submission.go api/upload.go belt/belt.go belt/blobs.go belt/execution.go belt/problem.go belt/queue-local.go belt/queue-remote.go belt/queue.go belt/stack.go belt/submission.go cmd/cactus/main.go cmd/cactus/router.go data/account.go data/blobs.go data/clarification.go data/contest.go data/db.go data/execution.go data/notification.go data/problem.go data/language.go data/standing.go data/submission.go hub/hub.go cube/proc.go cube/cube.go cube/docker.go cube/errors.go cube/plain.go cube/proc.go rpc/blobs.go rpc/executions.go rpc/languages.go rpc/problems.go rpc/queue.go rpc/submissions.go ui/assets.go ui/pages.go
